...
export default function WorkoutPlanDashboard({ workoutPlan, onStartWorkout, onResetWorkoutPlan }) {
  const { summary, days } = workoutPlan;

  return (
    <section className="dashboard" aria-live="polite">
      <div className="dashboard__intro dashboard__intro--with-action">
        <div>
          <h2>🏋️ Weekly Workout Plan</h2>
          <p>Built from a rule-based training template - no AI, fully reproducible.</p>
        </div>
        <button type="button" className="ghost-button" onClick={onResetWorkoutPlan}>
