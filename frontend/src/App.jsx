            ...
            <>
              ...
              {workoutStage === "done" && workoutPlan && !workoutLoading && (
                <WorkoutPlanDashboard
                  ...
                  onResetWorkoutPlan={() => {
                    // Only resets the workout side of things - nutrition
                    // results (result, nutritionInput) are left completely
                    // untouched, so there's no need to recalculate nutrition
                    // just to build a new workout plan.
                    setWorkoutPlan(null);
                    setWorkoutError(null);
                    setWorkoutStage("form");
                  }}
                />
              )}
            </>
